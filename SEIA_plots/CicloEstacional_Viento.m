...
%
% Christian Segura (DGEO-UdeC)
% Andres Sepulveda (DGEO-UdeC)
%
...
plotname=['cicloestacional_wrfout_',filename];% nombre output
...
title('Ciclo Estacional del Viento')
xlabel('Horas')
ylabel('Meses')
